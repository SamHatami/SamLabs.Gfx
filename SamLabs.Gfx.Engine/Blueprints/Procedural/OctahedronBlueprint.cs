...
public class OctahedronBlueprint : ProceduralBlueprintBase
{
    ...
    public override string Name => EntityNames.Octahedron;
    public override string GeometryType => EntityNames.Octahedron;
    ...
    public override MeshDataComponent GenerateMesh(Dictionary<string, float> parameters)
    {
        ...
        return MeshCreator.CreatePlane(size, size, "Octahedron");
    }
}
