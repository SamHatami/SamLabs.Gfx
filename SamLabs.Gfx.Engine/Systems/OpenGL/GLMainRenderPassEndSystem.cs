...
public class GLMainRenderPassEndSystem : RenderSystem
{
    ...
    public GLMainRenderPassEndSystem(EntityRegistry entityRegistry, IComponentRegistry componentRegistry, IGraphicsBackend graphicsBackend) : base(entityRegistry, componentRegistry)
    {
    ...
    {
        _graphicsBackend.EndMainRenderPass();
    }
}
